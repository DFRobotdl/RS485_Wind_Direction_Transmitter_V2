...
class RS485_Wind_Direction_Transmitter_V2 {
   public:
    /**
      ...
      @param serial - serial ports for communication, supporting hard and soft
      serial ports
    ...
    */
    ...
    /**
       @brief Revise wind drection sensor Modbus slave address. It takes effect
       right after being changed.

       @param Address1 Current Modbus slave address(0x00 is broadcast address,
    ...
    */
    ...
    /**
       ...
       @return false Failed
    */
    bool writeHoldingRegister(uint8_t Address,
                              uint16_t reg,
                              uint16_t parameter);
};
